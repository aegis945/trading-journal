...
class TradeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'strike':                 forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.5', 'placeholder': '5000', 'inputmode': 'decimal'}),
            'expiry':                 forms.DateInput(attrs={'class': _INPUT_CLASSES, 'type': 'date'}),
            'quantity':               forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'placeholder': '1', 'inputmode': 'numeric'}),
            'entry_price':            forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'placeholder': '5.50', 'x-model': 'entryPrice', 'inputmode': 'decimal'}),
            'exit_price':             forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'placeholder': '8.00', 'x-model': 'exitPrice', 'inputmode': 'decimal'}),
            ...
            'delta_entry':            forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.0001', 'placeholder': '0.3500', 'inputmode': 'decimal'}),
            'theta_entry':            forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.0001', 'placeholder': '-12.0000', 'inputmode': 'decimal'}),
            'vega_entry':             forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.0001', 'inputmode': 'decimal'}),
            'iv_entry':               forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.0001', 'placeholder': '0.2500', 'inputmode': 'decimal'}),
            'planned_stop_loss':      forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'x-model': 'stopLoss', 'inputmode': 'decimal'}),
            'planned_take_profit_1':  forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'x-model': 'tp1', 'inputmode': 'decimal'}),
            'planned_take_profit_2':  forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'inputmode': 'decimal'}),
            'planned_take_profit_3':  forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'step': '0.01', 'inputmode': 'decimal'}),
            'setup_quality':          forms.NumberInput(attrs={'class': _INPUT_CLASSES, 'min': '1', 'max': '5', 'placeholder': '3', 'inputmode': 'numeric'}),
            ...
            'ta_screenshot':          forms.ClearableFileInput(attrs={'class': _INPUT_CLASSES, 'accept': 'image/*', 'capture': 'environment'}),
